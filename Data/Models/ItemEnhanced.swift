// Data/Models/ItemEnhanced.swift
import Foundation
import GRDB

struct ItemEnhanced: Codable, FetchableRecord, Identifiable, Equatable {
    var entry: Int64
    var name: String
    var quality: Int
    var `class`: Int?
...
extension ItemEnhanced {

    /// Returns a formatted weapon speed string (e.g., "2.40 sec")
    ...
    /// Returns a formatted weapon damage string (e.g., "74 - 138 Damage")
    ...
    var formattedStats: [String] {
        ...
        addStat(type: stat_type5, value: stat_value5)
        addStat(type: stat_type6, value: stat_value6)
        addStat(type: stat_type7, value: stat_value7)
        addStat(type: stat_type8, value: stat_value8)
        addStat(type: stat_type9, value: stat_value9)
        addStat(type: stat_type10, value: stat_value10)
